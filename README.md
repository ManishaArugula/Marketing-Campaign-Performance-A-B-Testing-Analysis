...
### 4.1 Goal 1 – Campaign Revenue Efficiency
...
### 4.2 Goal 2 – A/B Variant Performance
...
This project demonstrates an end-to-end growth analytics workflow: defining business problems, selecting appropriate KPIs, validating and analysing data, evaluating performance across scale and efficiency, testing hypotheses, and communicating insights.
